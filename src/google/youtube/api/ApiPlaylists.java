...
import google.youtube.playlists.Response;
...
public class ApiPlaylists extends AsyncApi2<Response> {
	String key;
	String part = "snippet";
	String maxResults;
	String pageToken;
	...
	public ApiPlaylists(String key) {
		setKey(key);
	}
