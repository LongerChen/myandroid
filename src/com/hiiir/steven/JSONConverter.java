...
public class JSONConverter {
     ...
     *
     */
    protected static SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ssZ");
            ...
            for (int i = 0; i < farr.length; i++) {
                ...
                if (farr[i].getName().equals("mongoID")) {
                    ...
                    if (jo.has(farr[i].getName()) && !jo.isNull(farr[i].getName())) {
                        ...
                        } else if (farr[i].getType().equals(int.class)) {
                            farr[i].set(obj, Integer.parseInt(jo.get(farr[i].getName()).toString()));
                        } 
